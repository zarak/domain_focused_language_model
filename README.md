...
The code is split across the following three files: `utils.py`,
`train_model.py`, and `predict_model.py` all in the `src` directory.  

The perplexity is computed for a subset of the entire training set (1000 rows)
for ngrams of size 1, 2, 3, 4, and 5. To accomplish this type
```
